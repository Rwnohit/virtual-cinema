...
const STRINGS = {
  el: {
    ...
    'library.search': 'Ψάξε τίτλο, δημιουργό ή υπόθεση...',
    'library.noHits': 'Δεν βρέθηκε τίποτα με αυτό.',
    'library.allKinds': 'Όλα',
    'library.films2': 'Ταινίες',
    'library.series': 'Σειρές',
    'library.other': 'Υπόλοιπα',
    ...
    'dock.shareCamera': 'Μοιράσου την κάμερά σου με την αίθουσα',
  ...
  en: {
    ...
    'library.films': 'films',
    'library.search': 'Search a title, a creator or a plot...',
    'library.noHits': 'Nothing matched that.',
    'library.allKinds': 'All',
    'library.films2': 'Films',
    'library.series': 'Series',
    'library.other': 'The rest',
    ...
    'dock.shareCamera': 'Share your camera with the hall',
