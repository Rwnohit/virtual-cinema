...
const STRINGS = {
  el: {
    ...
    'library.hint': 'Διάλεξε ταινία και ξεκινάει για ΟΛΗ την αίθουσα, από το ίδιο σημείο.',
  ...
  en: {
    ...
    'library.hint': 'Pick a film and it starts for the WHOLE hall, from the same moment.',
